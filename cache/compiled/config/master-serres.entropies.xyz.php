...
return [
    ...
    'timestamp' => 1737303169,
    'checksum' => 'c514023ede6f7b852a648f3b594da679',
    'files' => [
        'user/serres.entropies.xyz/config' => [
            'security' => [
                'file' => 'user/serres.entropies.xyz/config/security.yaml',
                'modified' => 1737302788
            ],
            'themes/quark' => [
                'file' => 'user/serres.entropies.xyz/config/themes/quark.yaml',
                'modified' => 1737303169
            ]
        ],
        'user/config' => [
    ...
    'data' => [
        'themes' => [
            'quark' => [
                ...
                'custom_logo' => [
                    'user/themes/quark/images/logo/serres-logo.png' => [
                        'name' => 'serres-logo.png',
                        'full_path' => 'serres-logo.png',
                        'type' => 'image/png',
                        'size' => 11445,
                        'path' => 'user/themes/quark/images/logo/serres-logo.png'
                    ]
                ],
                'custom_logo_mobile' => [
